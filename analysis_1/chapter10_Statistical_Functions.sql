...
CREATE TABLE chapter10_acs_2011_2015_stats (
...
CREATE TABLE chapter10_widget_companies (
    id bigserial,
    company varchar(30) NOT NULL,
    widget_output integer NOT NULL
);

INSERT INTO chapter10_widget_companies (company, widget_output)
VALUES
...
FROM chapter10_widget_companies;

-- Listing 10-7: Applying rank() within groups using PARTITION BY

CREATE TABLE chapter10_store_sales (
    store varchar(30),
...
INSERT INTO chapter10_store_sales (store, category, unit_sales)
VALUES
    ('Broders', 'Cereal', 1104),
...
FROM chapter10_store_sales;

-- Listing 10-8: Create and fill a 2015 FBI crime data table

CREATE TABLE chapter10_fbi_crime_data_2015 (
    st varchar(20),
    city varchar(50),
    population integer,
...
SELECT * FROM chapter10_fbi_crime_data_2015
