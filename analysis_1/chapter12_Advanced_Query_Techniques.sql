-- Chapter 12 ADAVANCED QUERY TECHINIQUES
--------------------------------------------------------------
...
CREATE TABLE chapter4_us_counties_2010_top10 AS
SELECT * FROM chapter4_us_counties_2010;

DELETE FROM chapter4_us_counties_2010_top10
WHERE p0010001 < (
    SELECT percentile_cont(.9) WITHIN GROUP (ORDER BY p0010001)
    FROM chapter4_us_counties_2010_top10
    );

SELECT count(*) FROM chapter4_us_counties_2010_top10;
