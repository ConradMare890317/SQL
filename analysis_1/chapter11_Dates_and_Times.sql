...
CREATE TABLE chapter11_current_time_example (
    time_id bigserial,
    current_timestamp_col timestamp with time zone,
    clock_timestamp_col timestamp with time zone
);

INSERT INTO chapter11_current_time_example (current_timestamp_col, clock_timestamp_col)
    (SELECT current_timestamp,
            clock_timestamp()
     FROM generate_series(1,1000));

SELECT * FROM chapter11_current_time_example;
...
CREATE TABLE chapter11_time_zone_test (
    test_date timestamp with time zone
);
INSERT INTO chapter11_time_zone_test VALUES ('2020-01-01 4:00');

SELECT test_date
FROM chapter11_time_zone_test;
...
FROM 'C:\Users\conra\OneDrive\Desktop\SQL\SQL\analysis_1\yellow_tripdata_2016_06_01.csv'
...
CREATE TABLE chapter11_train_rides (
    trip_id bigserial PRIMARY KEY,
...
INSERT INTO chapter11_train_rides (segment, departure, arrival)
VALUES
...
SELECT * FROM chapter11_train_rides;
